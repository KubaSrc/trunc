...
% Home postion
x_h = T.x_end_avg(1); y_h = T.y_end_avg(1); z_h = T.z_end_avg(1);
...
f_metric = load('../metrics/forward_2023_09_13-23_01_10_7_496mm.mat');

fig = figure(31); clf; hold on; grid on

s=scatter3(1000.*(f_data(:,1)-x_h),1000.*(f_data(:,3)-z_h),1000.*(f_data(:,2)-y_h),[],f_metric.test_error,'filled','MarkerEdgeColor',"k",'LineWidth',1.25);
s.SizeData = 150;
